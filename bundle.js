...
var receiveTodos = exports.receiveTodos = function receiveTodos() {
  var todos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  return {
    type: RECEIVE_TODOS,
    todos: todos
  };
...
var receiveTodo = exports.receiveTodo = function receiveTodo() {
...
var _todo_list_container = __webpack_require__(61);
...
var _todo_actions = __webpack_require__(7);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(12), __webpack_require__(53)(module)))
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    receiveTodo: function receiveTodo(taskParams) {
      var actionFn = (0, _todo_actions.receiveTodo)(taskParams);
      dispatch(actionFn);
    }
  };
};
...
var _todo_form = __webpack_require__(77);
...
var todoList = function (_React$Component) {
  ...
  _createClass(todoList, [{
    ...
    value: function renderTodos() {
      ...
      var plsWork = Object.keys(this.props.todos).map(function (id) {
        return _this2.props.todos[id];
      });
      return plsWork.map(function (todo) {
        return _react2.default.createElement(
          'li',
          { key: todo.id },
          todo.title,
    ...
    key: 'render',
    value: function render() {
      var _Object$keys = Object.keys(this.props),
          todos = _Object$keys.todos;
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(props) {
    ...
    _this.handleTaskChange = _this.handleTaskChange.bind(_this);
    return _this;
  }

  _createClass(TodoForm, [{
    key: "handleTaskChange",
    value: function handleTaskChange(e) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("br", null),
          _react2.default.createElement("input", { type: "text", onChange: this.handleTaskChange }),
